<template>
  <div class="video">
    <div class="video_top">
      <div>
        <h1>【张捷财经】 美国通胀与美国产业链</h1>
        <div class="video_">
          <el-icon color="#999"><i-ep-VideoPlay /></el-icon><span>4.2万</span>
          <el-icon color="#999"><i-ep-ChatDotSquare /></el-icon
          ><span>517</span> <el-icon color="#999"><i-ep-Timer /></el-icon
          ><span>2022-06-20 11:57:37</span>
          <el-icon color="#d34242"><i-ep-Lock /></el-icon
          ><span>未经作者授权，禁止转载</span>
        </div>
      </div>
    </div>
    <div class="video_cen"></div>
    ...
    <div class="video_Tag">
      <div class="tag" v-for="tagitem in tag" :key="tagitem">
        <el-tag effect="dark" round class="mx-1"> {{ tagitem }} </el-tag>
      </div>
    </div>
  </div>
</template>
...
const tag = reactive(["知识","财经","美国","金融"])
